      ...
      return (
        <div className="space-y-8">
          <div className="text-center space-y-3">
            ...
            <p className="text-muted-foreground">Pick your path. No wrong answers.</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            >
              ...
              <div className="space-y-3 pr-12">
                ...
                <p className="text-sm text-muted-foreground">
                  Find jobs, track applications, get hired. No more spreadsheet chaos.
                </p>
              </div>
            ...
            >
              ...
              <div className="space-y-3 pr-12">
                ...
                <p className="text-sm text-muted-foreground">
                  Post jobs, find talent, skip the circus. Real candidates, real fast.
                </p>
              </div>
              <div className="mt-4 flex items-center gap-2 text-sm text-primary opacity-0 group-hover:opacity-100 transition-opacity">
                Let's go <ArrowRight className="w-4 h-4" />
    ...
    if (role === "candidate") {
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">We promise not to spam you. Ever.</p>
            </div>
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">Where can we reach you?</label>
                <Input
                  type="email"
      ...
      if (step === 2) {
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-2xl font-bold">What's your current situation?</h2>
              <p className="text-muted-foreground">No judgment. We've all been there.</p>
            </div>
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium">Current role (or last one)</label>
                <Input
                  placeholder="e.g. Frontend Developer, Product Designer..."
                  value={candidateData.currentRole}
                  onChange={(e) => setCandidateData({ ...candidateData, currentRole: e.target.value })}
                  className="h-12 bg-background/50"
                />
              </div>
              <div className="space-y-2">
      ...
      if (step === 3) {
        const openToOptions = ["Full-time", "Part-time", "Contract", "Freelance", "Remote", "Hybrid", "On-site"];
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-2xl font-bold">What are you open to?</h2>
              <p className="text-muted-foreground">Select all that apply. Be honest.</p>
            </div>
            <div className="flex flex-wrap gap-2">
              {openToOptions.map((option) => (
                ...
                >
                  {candidateData.openTo.includes(option) && <Check className="w-3 h-3 inline mr-1" />}
                  {option}
                </button>
              ))}
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium">Dream role (be specific)</label>
              <Input
                placeholder="e.g. Senior Engineer at a climate tech startup"
                value={candidateData.dreamRole}
                onChange={(e) => setCandidateData({ ...candidateData, dreamRole: e.target.value })}
                className="h-12 bg-background/50"
              />
            </div>
          </div>
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">This helps us match you better. Optional but powerful.</p>
            </div>
            <div className="space-y-2">
              <label className="text-sm font-medium flex items-center gap-2">
              ...
              <Textarea
                ...
                onChange={(e) => setCandidateData({ ...candidateData, superpower: e.target.value })}
      ...
      if (step === 5) {
        return (
          <div className="space-y-6 text-center">
            ...
            <div className="space-y-2">
              <h2 className="text-3xl font-bold">You're all set, {candidateData.name.split(' ')[0] || 'friend'}!</h2>
    ...
    if (role === "employer") {
      if (step === 1) {
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              <h2 className="text-2xl font-bold">Let's set up your hiring HQ.</h2>
              <p className="text-muted-foreground">Quick intro so we can help you hire faster.</p>
            </div>
            <div className="space-y-4">
              <div className="space-y-2">
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">This helps candidates understand who you are.</p>
            </div>
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium flex items-center gap-2">
        ...
        return (
          <div className="space-y-6">
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">Help us surface the right candidates.</p>
            </div>
            <div className="space-y-4">
              <div className="space-y-2">
                <label className="text-sm font-medium">Role(s) you're filling</label>
                <Input
                  placeholder="e.g. Senior Backend Engineer, Product Designer"
                  value={employerData.hiringFor}
                  onChange={(e) => setEmployerData({ ...employerData, hiringFor: e.target.value })}
                  className="h-12 bg-background/50"
                />
              </div>
              <div className="space-y-2">
      ...
      if (step === 4) {
        return (
          <div className="space-y-6 text-center">
            ...
            <div className="space-y-2">
              <h2 className="text-3xl font-bold">Welcome aboard, {employerData.name.split(' ')[0] || 'friend'}!</h2>
              <p className="text-muted-foreground max-w-md mx-auto">
                {employerData.company || "Your company"} is ready to hire smarter.
              </p>
            </div>
            <div className="p-4 rounded-xl bg-primary/5 border border-primary/20 text-left space-y-2">
              <p className="text-sm font-medium text-primary">What happens next:</p>
